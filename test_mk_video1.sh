...
ffmpeg -framerate 30 -pattern_type glob -i "$zTarget/$zESPACE/*.jpg" -vf crop=in_w:in_w*9/16,scale=1920:1080 -c:v h264_videotoolbox -b:v 10000k -r 30 -pix_fmt yuv420p $zTarget/$zESPACE/0_video.mp4
